...
public class TestCaseToolBar extends JToolBar {
    ...
    private void init() {
        ...
        aiGenerateButton = Utils.createButton("AI Generate", testCaseComp);
        aiGenerateButton.setText("AI Generate");
        aiGenerateButton.setToolTipText("Generate test cases using AI (Ctrl+Alt+G)");
        add(aiGenerateButton);
    ...
    public void enableAIGenerateButton() {
        if (aiGenerateButton != null) {
            aiGenerateButton.setEnabled(true);
        }
    }

    public void disableAIGenerateButton() {
        if (aiGenerateButton != null) {
